  ...
  return (
    <>
      ...
      <WorkListHeroSection
        ...
        pillImg="/img/play_marque.jpg"
        content={
          <>
            Tap into our powerhouse of storytellers, producers, and tech wizards. From brand IPs to viral hits, we create experiences that stay with you.
          </>
        }
      />
