...
export default function CCS({setisPopupOpen}) {
  ...
  return (
    <>
      <SEO
        title="Strategic Brand Solutions for B2C Brand | Red Bangle"
        description="Unlock powerful brand and campaign strategies with Red Bangle. Explore expert-led solutions designed to elevate B2C brands with innovative storytelling and strategy."
      ...
      <WorkListHeroSection
        ...
        content={
          <>
           We don&apos;t do boring. Our strategies spark conversations, drive results, and make sure your brand stays top of mind - where it belongs. 
          </>
        }
      />
      ...
      <section className="bg-white pt-15 md:pt-30 pb-7.5 md:pb-15">
        <div className="container">
          ...
          <h3 className="text-title md:text-title-md mb-10 md:mb-14 md:max-w-[576px] md:tracking-[-2.08px] font-everett">
            Strategies that drove brand growth
          </h3>
          <Button
            suffix={<LineArrow />}
            href="/contact"
