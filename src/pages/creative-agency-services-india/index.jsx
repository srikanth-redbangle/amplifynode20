...
const ServicesIndex = ({setisPopupOpen}) => {
  ...
  return (
    <>
      <SEO
        title="Red Bangle - The Creative Agency for B2C Brand Growth"
        description="Unlock B2C brand growth with Red Bangle’s solutions across brand strategy, creative campaigns, video content production, AI Influencers, technology and more."
      />

      <section
        className={`py-18 md:pt-23 md:pb-[162px] overflow-hidden bg-rb-service-grey`}
      >
        ...
        <div className="container">
          ...
          <h1 className="inline">
          Strategic brilliance, creative sparks, technology magic and flawless production.
            </h1>
          ...
          >
            <div className="xl:flex md:justify-center md:px-4 xl:px-0">
              <div className="flex px-4 md:px-0 md:-mx-4 lg:-mx-8 flex-wrap group-odd:flex-row-reverse">
                ...
                <div className={`w-full md:px-4 md:w-1/2 self-center md:max-w-[578px] `}>
                  ...
                  <div className={`gap-x-7 items-end grid ${s.key !== 'strategy'? 'md:grid-cols-2':''} my-7 md:my-10 text-sm md:text-base md:leading-5 tracking-[-0.16px] font-semibold`}>
                    <div>
                      {s.steps
