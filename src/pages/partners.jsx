...
const Partners = () => {
  ...
  return (
    <>
      {' '}
      <SEO
        title="Red Bangle - We deliver brand solutions with our partners"
        description="From media and PR to UI/UX - we work closely with established partners to offer brand and creative solutions that drive measurable growth for your brand."
      />
