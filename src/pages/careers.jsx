...
const Career = () => {
  ...
  return (
    <div>
      <SEO
        title="Careers at Red Bangle - The Brand Solutions Agency"
        description="Work with top brands on strategy, design, campaigns, content, AI, technology and more. Grow your career in a fun, bold environment. Explore opportunities today!"
      />
      ...
      <section className="py-16 md:py-30 bg-rb-mercury">
        <div className="container">
          <h1 className="font-everett text-[32px] md:text-[64px] xl:text-[120px] font-normal mb-8 md:mb-18 leading-[100%] uppercase">
            CALLING THINKERS, CREATORS & TECHNOLOGISTS

          </h1>

          <p className="text-sm md:text-accordion-large font-semibold max-w-[1153px] mb-10 md:mb-16">
            Come, disrupt and delight, inspire culture and curiosity, and launch and scale beautiful brands with Red Bangle.
      ...
      <section>
        <img src="/img/career/career-hero.webp" alt="career hero ad" className="w-full" />
      </section>
      ...
      <section className="py-15 md:pt-30 md:pb-0">
        <div className="container">
            ...
            {[
              {
                ...
                description:
                  '‘Red Gala’ is our annual organization-wide event where the best performing individuals and teams are recognised. Awards are trophies, certificates and goodies.',
              },
              {
                id: 1,
              ...
              },
              {
                ...
                description:
                  'Work on a Sunday or a public holiday, and you would be earning a compensatory off.',
              },
              {
                id: 4,
                title: 'Holidays',
                description:
                  'We offer 25 days of personal / sick leave in a year. We also offer 10 public holidays.',
              },
              {
                id: 5,
              ...
              },
              {
                ...
                title: 'Coffee & Snacks',
                description:
                  'The official-4pm-company-sponsored snack is fresh fruit or a salad. And there’s always a great pot of single-estate black coffee brewing.',
              },
              {
                id: 9,
                title: 'Conversations & Socials',
                description:
                  'We love gathering inspiration and celebrating growth. We have Coffee Conversations with inspiring guests once a month, and otherwise there’s lots of cake, some team socials and a big fat Diwali Potluck party.',
              },
              {
                id: 10,
                title: 'Furry Friends',
