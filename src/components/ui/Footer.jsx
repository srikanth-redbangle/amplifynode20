...
const group_url = process.env.NEXT_PUBLIC_GROUP
const global_url = process.env.NEXT_PUBLIC_B2B
...
const socials = [
  {
    ...
    href: 'https://www.linkedin.com/company/redbangleindia/',
    title: (
...

  {
    ...
    href: 'https://www.instagram.com/redbangle.india/#',
...
const offices = [
  {
    ...
    location:
      <>
        <div>
          2nd Floor, Silver Rock,<br /> 12, Nandi Durga Road, 1, 1st Main Road,<br /> Bengaluru, Karnataka 560046
        </div>
      </>,
  ...
  },
  {
    ...
    location:
      <>
        <Link href="/contact" className="text-rb-red max-w-max">Contact us</Link> to connect<br />
        with our team in Delhi
      </>,
  },
  // {
  //   key: 1,
...
const links = [
  ...
  {
    href: group_url,
    imgSrc: "/img/group-icon.png",
    imgAlt: "India",
    text: "Visit Red Bangle Group",
  },
  {
    href: global_url,
    imgSrc: "/img/b2b-icon.png",
    imgAlt: "Global",
    text: "Visit Red Bangle B2B",
  },
]
export const Footer = ({ hasContactForm }) => {
  ...
  return (
    <footer>
      {hasContactForm && currentPath != '/blog' && currentPath != '/custom-campaign-landing-page' && currentPath != '/end-to-end-video-production' && currentPath != '/career' && <ContactSection />}

      {
        ...
        <>
          ...
          ${['Delhi', 'Mumbai'].includes(o.city) ? 'md:pl-[70px]' : ''}`}
                    >
                      {o.city}
                    </div>
                    <div
                      className={`mt-2 mb-5.5 md:mb-8 text-sm md:text-base text-rb-black/70  
          ${['Delhi', 'Mumbai'].includes(o.city) ? 'md:pl-[70px] !mb-0' : ''}`}
                    >
                      {o.location}
                    </div>
                    {o.href ? (
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 gap-y-5.5 md:gap-y-0 md:gap-x-18 md:flex md:flex-wrap">
                {socials.map((s) => (
                  <a
                    ...
                    className={`flex items-center text-social-small md:text-social font-semibold text-rb-dune/80 max-w-max group ${s?.className ?? ''
                      }`}
                  >
      ...
      <section className="py-15 md:pt-20 md:pb-8 bg-white">
        <div className="container">
          <div className="flex flex-col lg:flex-row justify-between items-start w-full px-2">
            {/* First Div - Footer Links */}
            <div className="w-full lg:w-2/3">
              <div className="grid gap-y-15 grid-cols-2 md:grid-cols-5">
                <div className="">
                  ...
                  <div className={styles.links}>
                    ...
                    >
                      ...
                      {/* <svg
                          width="14"
                          height="11"
                          className="ml-2 inline-block" // Reduced margin-left from 7 to 2
                          viewBox="0 0 14 11"
                          fill="none"
                          xmlns="http://www.w3.org/2000/svg"
                        >
                    ...
                    <Link
                      href="https://www.staging.b2c.redbangle.com/collab"
                      data-rb-cursor-state="invisible"
                      className="hover:text-rb-red max-w-max"
                    >
                      Collab
                ...
                <div className="md:ml-4">
                  <div className={styles.title}>
                    <Link
                      href="/work/featured"
                      className="flex gap-1 group hover:text-rb-red transition-all  "
                    >
                      WORK
                  ...
                  <div className={styles.links}>
                     <Link
                      href="/work/brand-design-agency-india"
                      data-rb-cursor-state="invisible"
                      className="hover:text-rb-red max-w-max"
                    >Design
                    </Link>
                    <Link
                      href="/work/brand-campaign-agency-india"
                      data-rb-cursor-state="invisible"
                      className="hover:text-rb-red max-w-max"
                    >
                      Campaign
                    ...
                    <Link
                      href="/work/video-content-production-agency-india"
                      data-rb-cursor-state="invisible"
                      className="hover:text-rb-red max-w-max"
                    >
                      Content
                    ...
                    <Link
                      href="/work/immersive-experience-agency-india"
                      data-rb-cursor-state="invisible"
                      className="hover:text-rb-red max-w-max"
                    >
                      Experience
                    ...
                    <Link
                      href="/work/integrated-brand-campaign-agency-india"
                      data-rb-cursor-state="invisible"
                      className="hover:text-rb-red max-w-max"
                    >
                      Integrated
                ...
                <div className="md:ml-4">
                  <div className={styles.title}>
                    <Link
                      href="/creative-agency-services-india"
                      className="flex gap-1 group hover:text-rb-red transition-all "
                    >
                      SERVICES
                      <CornerArrow className="w-5 h-5 transition-all duration-100 group-hover:translate-x-0.5 group-hover:-translate-y-0.5" />
            ...
            <div className="w-full lg:w-[25%] lg:flex lg:flex-col mt-[2rem] md:mt-0 md:mb-0">
          ...
          <div className="flex flex-col-reverse md:flex-row border-t mt-10.5 md:mt-[160px] border-t-rb-black/20 pt-10.5 md:pt-8 justify-between">
