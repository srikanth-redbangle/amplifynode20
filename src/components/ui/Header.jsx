...
const outsideLinks = [
  ...
  //     { title: 'Integrated', href: '/work' },
  //     { title: 'Design', href: '' },
  //     { title: 'Campaign', href: '/work' },
  //     { title: 'Content', href: '/work' },
  //     { title: 'Technology', href: '/work' },
  //     { title: 'AI', href: '/work' },
  ...
  // },
  {
    title: 'Services',
    menu: [
      { title: 'All', href: '/creative-agency-services-india' },
      { title: 'Strategy', href: '/brand-strategy-agency-india' },
      { title: 'Design', href: '/brand-design-agency-india' },
      { title: 'Campaign', href: '/brand-campaign-agency-india' },
      { title: 'Content', href: '/video-content-production-agency-india' },
      { title: 'Artificial Intelligence', href: '/creative-ai-agency-india' },
      { title: 'Experience', href: '/immersive-experience-agency-india' },
      { title: 'Production', href: '/film-and-video-production-agency-india' },
    ],
  },
  // {
  //   title: 'Work',
  ...
  //     // { title: 'All', href: '#!' },
  //     // { title: 'Think', href: '/work/leap' },
  //     { title: 'Strategy', href: '/work/strategy' },
  //     { title: 'Design Coming soon', href: '' },
  //     { title: 'Campaign', href: '/work/campaign' },
  //     { title: 'Content', href: '/work/content' },
  //     { title: 'Technology', href: '/work/technology' },
  //     // { title: 'Leap (L74 Case study)', href: '/work/l74-case-study' },
  //   ],
  // },
  {
    ...
    menu: [
      ...
      { title: 'SomeAIra Coming soon', href: '' },
    ],
  },
  {
    title: 'About',
  ...
  return (
    <>
      <header className="relative">
        <div className="flex items-center h-[60px] md:h-[85px] border-b border-b-black/10 bg-rb-white">
                ...
                work
                    ...
                    {outsideLinks.map((l, i) => (
                      ...
                      >
                        ...
                        <div className="absolute  font-medium min-w-[240px] p-6 top-20 rounded-lg shadow-menu invisible group-hover:visible group-hover:opacity-100 transition-all opacity-0 flex flex-col z-[1] bg-white">
{l.menu?.map((lItem, li) => {
  const isComingSoon = lItem.title.includes('Coming soon');
  const titleText = lItem.title.replace('Coming soon', '').trim();

  return (
    <div key={li} className="mt-4 first:mt-0">
      {isComingSoon ? (
        // Show trimmed title with "Coming soon" below
        <div className="text-lg leading-6 text-rb-black transition-all">
          <span className="block">{titleText}</span>
          <span className="block text-[0.7875rem] mt-[-4px]">Coming soon</span>
        </div>
      ) : (
        // Regular working link
        <Link
          href={lItem.href}
          className="text-lg leading-6 block hover:text-rb-red text-rb-black transition-all"
        >
          {lItem.title}
        </Link>
      )}
          ...
          <div className="flex flex-wrap -mx-2">
            <div className="hidden md:block px-2 w-2/5">
              <div className="py-10 max-w-[430px] flex flex-col h-full">
                <div className="mb-10">
                  <Link href="/">
                    <img src="/logo-1.png" alt="" className='w-[190px]'/>
                  </Link>
                </div>
                ...
                <div className="flex gap-4 justify-between gap-x-[35px] flex-1 md:mb-2 ">
                  <div>
                  ...
                  <div>
                    <p className="text-[18px] font-semibold mb-6 pl-[30px] uppercase">
                      Industries
                    </p>

                    <div className="grid grid-cols-1 grid-flow-col gap-x-[15px] gap-y-[11px] items-start pointer-events-none">
                      <div className="flex flex-col gap-y-[11px]">
                        <Link href="/industries" className="opacity-60 hover:opacity-100 tracking-[-0.64px] ml-8">Fintech</Link>
                        <Link href="/industries" className="opacity-60 hover:opacity-100 tracking-[-0.64px] ml-8">Electric Vehicles</Link>
                        <Link href="/#! " className="opacity-60 hover:opacity-100 tracking-[-0.64px] ml-8"> E-Commerce</Link>
                        <Link href="/#! " className="opacity-60 hover:opacity-100 tracking-[-0.64px] ml-8">Consumer Electronics</Link>
                        <Link href="/#! " className="opacity-60 hover:opacity-100 tracking-[-0.64px] ml-8">Food & Beverage</Link>
                          <Link href="/#! " className="opacity-60 hover:opacity-100 tracking-[-0.64px] ml-8">Beauty & Personal Care
</Link>
                      </div>
                      
                      {/* <div className="flex flex-col gap-y-[11px]">
                        <Link href="/industries" className="opacity-60 hover:opacity-100 tracking-[-0.64px]">Consumer Electronics</Link>
                        <Link href="/industries" className="opacity-60 hover:opacity-100 tracking-[-0.64px]">Hospitality</Link>
                        <Link href="/#! " className="opacity-60 hover:opacity-100 tracking-[-0.64px]">EdTech</Link>
                        <Link href="/#! " className="opacity-60 hover:opacity-100 tracking-[-0.64px]">Real Estate</Link>
                        <Link href="/#! " className="opacity-60 hover:opacity-100 tracking-[-0.64px]">Fantasy Sports</Link>
                      </div> */}
                    </div>
            ...
            >
              <div
                data-lenis-prevent
                ref={contentlenisRef}
                className="overflow-y-auto overflow-x-hidden nav-wrapper"
              >
                ...
                <div className="flex flex-col gap-6 md:gap-8 items-start pb-20">
                  ...
                  <div
                    className="nav-link opacity-30 duration-300 ease-out hover:opacity-100 order-2"
                  >
                    <Link
                      href="/work/featured"
                      className="text-[40px] md:text-[64px] leading-[100%] font-everett tracking-[-2.7px]"
                  ...
                  <div
                    className={`dropdown relative nav-link opacity-30 duration-300 ease-out hover:opacity-100 order-3 ${dropdownMenu === 0 ? 'open' : ''
                      }`}
                  >
                    <button
                    ...
                    <div>
                        <Link href="/creative-agency-services-india">All</Link>
                      </div>
                      <div>
                        <Link href="/brand-strategy-agency-india">Strategy</Link>
                      </div>
                      <div>
                      <Link href="/brand-design-agency-india">Design</Link>
                      </div>
                      <div>
                        <Link href="/brand-campaign-agency-india">Campaign</Link>
                      </div>
                      <div>
                        <Link href="/video-content-production-agency-india">Content</Link>
                      </div>
                      <div>
                        <Link href="/creative-ai-agency-india"> Artificial Intelligence </Link>
                      </div>
                      <div>
                        <Link href="/immersive-experience-agency-india" >Experience</Link>
                      </div> 
                      <div>
                      <Link href="/film-and-video-production-agency-india">Production</Link>
                      </div>
                    </div>
                  </div>
                  ...
                  AI INFLUENCERS
                    ...
                    <div className="dropdown-menu rounded-lg bg-white py-5 px-6 ">
                      ...
                      <div>
                        <Link href=""><span className='text-rb-black cursor-default' >SomeAIra <br/>
                          <span className='text-[0.7875rem] font-semibold mt-[-4px]'>Coming soon</span>
                          </span>
                        </Link>
                      </div>
              ...
              {/* <div
                    className="nav-link opacity-30 duration-300 ease-out  order-4"
                  >
                    <Link
                      href="/"
                      className="text-[40px] md:text-[64px] leading-[100%] font-everett tracking-[-2.7px] cursor-default"
