...
export const ContentPostCard = ({
  ...
  >
    ...
    >
      ...
      />
      <div
        className={`flex flex-wrap text-white justify-start absolute left-4 bottom-4.5 md:bottom-5 md:left-5 z-[1] mr-2 font-semibold text-xs ${type === 'md' ? 'gap-3 gap-x-2  lg:max-w-[71%]' : 'gap-3 md:gap-2'
          }`}
      >
