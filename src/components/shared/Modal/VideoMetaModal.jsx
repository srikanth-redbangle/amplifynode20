...
export const VideoMetaModal = ({ loading, open, setOpen, video, title }) => {
  ...
  return (
    ...
    >
      ...
      <div className="relative overflow-hidden rounded">
        ...
        {!loading && open && video && (
          <div
            className="bg-white max-w-[calc(100vw_-_64px)] cursor-auto md:max-w-[calc(100vw_-_128px)] lg:max-w-[calc(60vw_-_128px)] max-h-[90vh] rb-scrollbar overflow-y-auto"
            data-lenis-prevent
          >
            ...
            <div className="bg-black aspect-video">
              {video?.workDetails?.videolink === "https://rb-video-poc.s3.ap-south-1.amazonaws.com/infosystopaz/index.html" ? (
                <iframe
            ...
            <div className="flex flex-wrap px-8 py-6 md:px-16 md:py-9 text-sm leading-4 md:text-base">
              ...
              <div className="w-full md:w-1/3 mt-8 md:mt-[32px] md:px-3">
                {/* <h3 className=" text-rb-red text-2xl font-semibold">
                  Project Details
                </h3> */}

                <ul className={`mt-4 grid grid-cols-1 gap-1 ${title === 'Tata Women’s Cricket Premiere League' ? 'md:mt-14': 'mt-6'}`}>
